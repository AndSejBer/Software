...
public class sheetCard2 extends JPanel{
	...
	public sheetCard2(ADM parent) {
		JLabel AbilityName = new JLabel("Ability Name");
		JLabel AbilityScore = new JLabel("Ability Score");
		JLabel AbilityModifier = new JLabel("Ability Modifier");
		JLabel TemporaryScore = new JLabel("Temporary Score");
		JLabel TemporaryModifier = new JLabel("Temporary Modifier");
